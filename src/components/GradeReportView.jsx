...
function band(score) {
  if (score >= 85)
    return {
      ...
      ring: "stroke-grade-excellent",
      bg: "bg-grade-excellent/10",
    };
  if (score >= 70)
    return {
      label: "Good",
      color: "text-grade-good",
      ring: "stroke-grade-good",
      bg: "bg-grade-good/10",
    };
  if (score >= 50)
  ...
  return {
    label: "Needs work",
    color: "text-grade-poor",
    ring: "stroke-grade-poor",
    bg: "bg-grade-poor/10",
  };
}
...
export function GradeReportView({ report, jobTitle, company }) {
